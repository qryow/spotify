...
import { getSongs, setSelectedSong } from '../../../store/Slices/SongSlice';
              ...
              <div className={style.main__block}>
                ...
                <div className={style.profile__block}>
                  ...
                  <div className={style.profile__names}>
                    ...
                    <h3 onClick={() => setModal(true)}> Все песни </h3>
                ...
                <div className={style.songs__list}>
                  ...
                  <hr />
                  {Array.isArray(songs) &&
                    songs.map((music: PlaylistSong) => (
                      <React.Fragment>
                        <OneSong key={music.id} music={music} />
                      </React.Fragment>
                    ))}
                </div>
